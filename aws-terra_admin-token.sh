...
#
# aws --profile youriamuser sts get-session-token --duration 3600 --serial-number arn:aws:iam::012345678901:mfa/user --token-code 012345
#
...
AWS_USER_PROFILE=`echo $0 | awk -F "-" '{print $2}'`
#AWS_USER_PROFILE=$1
AWS_MFA_PROFILE=MFA
ARN_OF_MFA=arn:aws:iam::304149346685:mfa/$AWS_USER_PROFILE
MFA_TOKEN_CODE=$1
DURATION=43200
